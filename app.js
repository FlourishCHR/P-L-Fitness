...
app.get('*', (req, res, next) => {
  ...
  if (req.path.startsWith('/auth') || req.path.startsWith('/admin') ||
      req.path.startsWith('/users') || req.path.startsWith('/memberships') ||
      req.path.startsWith('/payments') || req.path.startsWith('/products') ||
      req.path.startsWith('/ranks') || req.path.startsWith('/experience') ||
      req.path.startsWith('/achievements') || req.path.startsWith('/sessions') ||
      req.path.startsWith('/attendance') || req.path.startsWith('/vouchers') ||
      req.path.startsWith('/rewards') || req.path.startsWith('/equipment') ||
      req.path.startsWith('/product-categories')) {
    return next();
  }
